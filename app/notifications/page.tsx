...
export default function NotificationsPage() {
  ...
  return (
    <DashboardLayout role="seeker" userName="Ahmed Abdullah" notificationCount={unreadCount}>
      <div>
          ...
          <div className="space-y-2">
            {filtered.map((notif) => (
              ...
              >
                {/* Icon */}
                <div className={cn(
                  "w-9 h-9 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center text-base sm:text-lg flex-shrink-0",
